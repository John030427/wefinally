...
function sanitizeUser(u) {
  ...
  return {
    ...
    occupation_description: u.occupation_description || '',
    city: u.city,
    ...
    status: u.status,
    member_status: u.member_status || (u.status === USER_STATUS.NORMAL ? 'approved' : 'pending_profile'),
    member_status_updated_at: u.member_status_updated_at || null,
    is_vip: vip ? 1 : 0,
    isVip: vip,
