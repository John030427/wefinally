...
assert(view.indexOf('AI匹配报告') < view.indexOf('算法与报告细节'))
assert(view.includes('{{totalScorePercent}}分'))
assert(view.includes('帮助平台改进匹配'))
assert(view.includes('不会立即改变本次分数'))
assert(!view.includes('帮助平台校准匹配'))
