...
async function main() {
  ...
  assert.strictEqual(detail.paired_conversation.sides.a.selected, true)
  assert.strictEqual(detail.paired_conversation.sides.b.selected, false)
  ...
  assert.strictEqual(conversation.paired_conversation.coordination.coordination_ref, 'WF-D-000030')
  assert.strictEqual(conversation.paired_conversation.sides.a.session.session_ref, 'WF-S-000010')
  assert.strictEqual(conversation.paired_conversation.sides.b.session.session_ref, 'WF-S-000011')
  assert.strictEqual(conversation.paired_conversation.sides.a.messages[0].content, '我想投诉重复扣费')
  assert.strictEqual(conversation.paired_conversation.sides.b.messages[0].content, '周六下午我可以。')
  assert.strictEqual(conversation.paired_conversation.shared_events[0].event_type, 'application_sent')
  assert.strictEqual(Object.prototype.hasOwnProperty.call(conversation.paired_conversation.sides.a.session, 'user_id'), false)
