...
const REALISTIC_MATCH_PROFILES = [
  ...
  profile('wf_real_10_f_sz_visual26', { gender: 2, age: 23, city: '深圳', occupation: '视觉设计师', marry_status: '未婚', baby_plan: '3-5年内', drinking_status: '偶尔饮酒', appearance_description: '时尚短发，偏瘦', appearance_want: '清爽、有审美、不过度商务', setting: setting('普普通通，善解人意，对我好，不做作，不矫情', '三观无敌爆炸好，很善良，乐于助人，可以付出一切', '事业发展优先，不接受一年内催婚催育', null, { age_min: 24, age_max: 30, height_min: 185, height_max: 205, like_baby_plan: '5年后' }) }),
