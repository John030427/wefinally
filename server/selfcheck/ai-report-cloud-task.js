...
assert(minimax.includes('max_tokens: 1800'))
assert(minimax.includes('summary 不超过 300 个汉字'))
assert(minimax.includes('generatePlainFallbackReport'))
assert(minimax.includes('const CLOUD_FUNCTION_SAFE_TIMEOUT_MS = 45000'))
assert(minimax.includes('Math.max(configuredTimeoutMs, CLOUD_FUNCTION_SAFE_TIMEOUT_MS)'))
