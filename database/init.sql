...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `occupation_description` varchar(100) DEFAULT '' COMMENT '职业圈层选择其他时填写',
  ...
  `member_status` varchar(30) NOT NULL DEFAULT 'pending_profile' COMMENT 'pending_profile/pending_review/need_more_info/approved/rejected/disabled',
  `member_status_updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `partner_user_audit_log` (
  ...
  `action` varchar(30) NOT NULL COMMENT 'approve/need_more_info/reject/disable/restore/reassign',
