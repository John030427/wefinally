/**
 * Static China province → city catalog for user-declared residence.
 * No GPS / getLocation / startLocationUpdate.
 * Keep compact: major metros + common second-tier cities.
 */
...
const REGION_CATALOG = [
  {
    ...
    province_name: '北京市',
    cities: [{ city_code: '110100', city_name: '北京' }]
  },
  {
    province_code: '120000',
    province_name: '天津市',
    cities: [{ city_code: '120100', city_name: '天津' }]
  },
  {
    province_code: '310000',
    province_name: '上海市',
    cities: [{ city_code: '310100', city_name: '上海' }]
  },
  {
    province_code: '500000',
    province_name: '重庆市',
    cities: [{ city_code: '500100', city_name: '重庆' }]
  },
  {
  ...
  },
  {
    ...
    province_name: '湖北省',
    cities: [{ city_code: '420100', city_name: '武汉' }]
  },
  {
    province_code: '610000',
    province_name: '陕西省',
    cities: [{ city_code: '610100', city_name: '西安' }]
  },
  {
    province_code: '430000',
    province_name: '湖南省',
    cities: [{ city_code: '430100', city_name: '长沙' }]
  },
  {
    province_code: '410000',
    province_name: '河南省',
    cities: [{ city_code: '410100', city_name: '郑州' }]
  },
  {
...
/** Flat list for backward-compatible pickers */
