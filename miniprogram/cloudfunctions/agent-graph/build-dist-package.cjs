...
const { copyCoordinationAdapters } = require('../sync-coordination-adapters.cjs')
...
copyCoordinationAdapters({
  graphArtifact: path.join(distDir, 'shared', 'coordinationAdapters.cjs')
})
