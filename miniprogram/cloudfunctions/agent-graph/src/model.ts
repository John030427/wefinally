...
const DATE_COORDINATION_SYSTEM_PROMPT = [
  ...
  'Example 6 user: 我到了，你在哪. command: {"type":"ASK_PARTNER_ARRIVAL","partner_request":{"type":"ASK_ARRIVAL","topic":"询问对方是否已到达以及所在公共集合点"},"context_ref":{"type":"meeting_status","coordination_id":716,"coordination_version":6},"confidence":0.98}. Do not reveal private location data.',
