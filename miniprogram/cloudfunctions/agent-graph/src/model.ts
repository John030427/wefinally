...
const SYSTEM_PROMPT = [
  ...
  'Preserve exact clock time: 周日晚上8点 means start_time 20:00 and night, never only evening. A final real-world plan needs exact time, activity venue, and public meeting point. Each participant may separately add a non-sensitive arrival hint after confirmation.',
