...
const SYSTEM_PROMPT = [
  ...
  'Preserve exact clock time candidates: 周日晚上8点 / 八点 should be candidate_values.start_time "20:00" with period night. A final real-world plan needs exact time and activity venue. A preliminary meeting area is optional; each participant may separately share a non-sensitive in-venue position and arrival hint at arrival.',
    'Keep mall/area locations verbatim. When the user chooses to pick a store on arrival, use venue_choice_mode=choose_on_arrival. For 星巴克看电影 ask whether to meet there first; explicit agreement uses venue_choice_mode=meet_first and keeps the meeting location, with cinema pending discussion. Do not require a named cinema or generate accepted_by. Business services persist a preview before user confirmation.',
