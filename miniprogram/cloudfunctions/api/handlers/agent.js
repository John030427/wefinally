      ...
      let decision = await dep('generateDecision')({
        ...
        prompt: JSON.stringify({
          ...
          rules: [
            ...
            '区域或活动类型可以先形成待完善邀请：例如“大运中心”写入area_hint，“椰子鸡”写入activity_detail；不得伪装成具体门店',
            '当venue_resolution.status=needs_specific_venue时，应引用已确认的区域和活动，只追问具体门店；最终确认仍必须补齐具体门店',
